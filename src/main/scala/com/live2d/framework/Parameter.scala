...
import com.live2d.framework.exception.ParameterInvalidException
...
case class Parameter(private val pointer: Pointer, id: String, min: Float, max:Float, default: Float) {
   ...
   * @throws  com.live2d.framework.exception.ParameterInvalidException if the assigned value is invalid.
   */
