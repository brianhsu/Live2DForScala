package moe.brianhsu.porting.live2d.gateway.avatar.settings.impl.json

import moe.brianhsu.porting.live2d.RichPath._
import moe.brianhsu.porting.live2d.enitiy.avatar.settings.Settings
import moe.brianhsu.porting.live2d.enitiy.avatar.settings.detail.{ExpressionSetting, MotionSetting, PoseSetting}
import moe.brianhsu.porting.live2d.gateway.avatar.settings.SettingsReader
import moe.brianhsu.porting.live2d.gateway.avatar.settings.impl.json.model.{Group, ModelSetting}
