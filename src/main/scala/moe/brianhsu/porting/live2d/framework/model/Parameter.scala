 ...
 * @param belongsTo   Which Live2DModel of this parameter belongs to.
 ...
 */
case class Parameter(private val pointer: Pointer, belongsTo: Live2DModel, id: String, min: Float, max: Float, default: Float) {
