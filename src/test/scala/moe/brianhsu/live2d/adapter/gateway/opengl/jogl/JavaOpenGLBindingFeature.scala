...
class JavaOpenGLBindingFeature extends AnyFeatureSpec with Matchers with GivenWhenThen with MockFactory {
  Feature("OpenGL constant") {
    Scenario("Validate OpenGL constant") {
      ...
      binding.openGLConstants.GL_TEXTURE_2D shouldBe GL.GL_TEXTURE_2D
      binding.openGLConstants.GL_RGBA shouldBe GL.GL_RGBA
      binding.openGLConstants.GL_UNSIGNED_BYTE shouldBe GL.GL_UNSIGNED_BYTE
      binding.openGLConstants.GL_TEXTURE_MIN_FILTER shouldBe GL.GL_TEXTURE_MIN_FILTER
      binding.openGLConstants.GL_LINEAR_MIPMAP_LINEAR shouldBe GL.GL_LINEAR_MIPMAP_LINEAR
      binding.openGLConstants.GL_TEXTURE_MAG_FILTER shouldBe GL.GL_TEXTURE_MAG_FILTER
      binding.openGLConstants.GL_LINEAR shouldBe GL.GL_LINEAR
      binding.openGLConstants.GL_VERTEX_SHADER shouldBe GL2ES2.GL_VERTEX_SHADER
      binding.openGLConstants.GL_FRAGMENT_SHADER shouldBe GL2ES2.GL_FRAGMENT_SHADER
      binding.openGLConstants.GL_INFO_LOG_LENGTH shouldBe GL2ES2.GL_INFO_LOG_LENGTH
      binding.openGLConstants.GL_ZERO shouldBe GL.GL_ZERO
      binding.openGLConstants.GL_ONE shouldBe GL.GL_ONE
      binding.openGLConstants.GL_ONE_MINUS_SRC_ALPHA shouldBe GL.GL_ONE_MINUS_SRC_ALPHA
      binding.openGLConstants.GL_ONE_MINUS_SRC_COLOR shouldBe GL.GL_ONE_MINUS_SRC_COLOR
      binding.openGLConstants.GL_DST_COLOR shouldBe GL.GL_DST_COLOR
      binding.openGLConstants.GL_TEXTURE1 shouldBe GL.GL_TEXTURE1
      binding.openGLConstants.GL_TEXTURE0 shouldBe GL.GL_TEXTURE0
      binding.openGLConstants.GL_FLOAT shouldBe GL.GL_FLOAT
      binding.openGLConstants.GL_ARRAY_BUFFER_BINDING shouldBe GL.GL_ARRAY_BUFFER_BINDING
      binding.openGLConstants.GL_ELEMENT_ARRAY_BUFFER_BINDING shouldBe GL.GL_ELEMENT_ARRAY_BUFFER_BINDING
      binding.openGLConstants.GL_CURRENT_PROGRAM shouldBe GL2ES2.GL_CURRENT_PROGRAM
      binding.openGLConstants.GL_ACTIVE_TEXTURE shouldBe GL.GL_ACTIVE_TEXTURE
      binding.openGLConstants.GL_TEXTURE_BINDING_2D shouldBe GL.GL_TEXTURE_BINDING_2D
      binding.openGLConstants.GL_VERTEX_ATTRIB_ARRAY_ENABLED shouldBe GL2ES2.GL_VERTEX_ATTRIB_ARRAY_ENABLED
      binding.openGLConstants.GL_SCISSOR_TEST shouldBe GL.GL_SCISSOR_TEST
      binding.openGLConstants.GL_STENCIL_TEST shouldBe GL.GL_STENCIL_TEST
      binding.openGLConstants.GL_DEPTH_TEST shouldBe GL.GL_DEPTH_TEST
      binding.openGLConstants.GL_CULL_FACE shouldBe GL.GL_CULL_FACE
      binding.openGLConstants.GL_BLEND shouldBe GL.GL_BLEND
      binding.openGLConstants.GL_FRONT_FACE shouldBe GL.GL_FRONT_FACE
      binding.openGLConstants.GL_COLOR_WRITEMASK shouldBe GL.GL_COLOR_WRITEMASK
      binding.openGLConstants.GL_BLEND_SRC_RGB shouldBe GL.GL_BLEND_SRC_RGB
      binding.openGLConstants.GL_BLEND_DST_RGB shouldBe GL.GL_BLEND_DST_RGB
      binding.openGLConstants.GL_BLEND_SRC_ALPHA shouldBe GL.GL_BLEND_SRC_ALPHA
      binding.openGLConstants.GL_BLEND_DST_ALPHA shouldBe GL.GL_BLEND_DST_ALPHA
      binding.openGLConstants.GL_FRAMEBUFFER_BINDING shouldBe GL.GL_FRAMEBUFFER_BINDING
      binding.openGLConstants.GL_VIEWPORT shouldBe GL.GL_VIEWPORT
      binding.openGLConstants.GL_FALSE shouldBe GL.GL_FALSE
      binding.openGLConstants.GL_TRUE shouldBe GL.GL_TRUE
      binding.openGLConstants.GL_ARRAY_BUFFER shouldBe GL.GL_ARRAY_BUFFER
      binding.openGLConstants.GL_ELEMENT_ARRAY_BUFFER shouldBe GL.GL_ELEMENT_ARRAY_BUFFER
      binding.openGLConstants.GL_TEXTURE_WRAP_S shouldBe GL.GL_TEXTURE_WRAP_S
      binding.openGLConstants.GL_CLAMP_TO_EDGE shouldBe GL.GL_CLAMP_TO_EDGE
      binding.openGLConstants.GL_TEXTURE_WRAP_T shouldBe GL.GL_TEXTURE_WRAP_T
      binding.openGLConstants.GL_FRAMEBUFFER shouldBe GL.GL_FRAMEBUFFER
      binding.openGLConstants.GL_COLOR_ATTACHMENT0 shouldBe GL.GL_COLOR_ATTACHMENT0
      binding.openGLConstants.GL_COLOR_BUFFER_BIT shouldBe GL.GL_COLOR_BUFFER_BIT
      binding.openGLConstants.GL_CCW shouldBe GL.GL_CCW
      binding.openGLConstants.GL_TRIANGLES shouldBe GL.GL_TRIANGLES
      binding.openGLConstants.GL_UNSIGNED_SHORT shouldBe GL.GL_UNSIGNED_SHORT
      binding.openGLConstants.GL_SRC_ALPHA shouldBe GL.GL_SRC_ALPHA
      binding.openGLConstants.GL_DEPTH_BUFFER_BIT shouldBe GL.GL_DEPTH_BUFFER_BIT
      binding.openGLConstants.GL_TRIANGLE_FAN shouldBe GL.GL_TRIANGLE_FAN
    }
  }
