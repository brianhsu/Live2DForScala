...
import moe.brianhsu.porting.live2d.enitiy.avatar.settings.detail.ExpressionSetting.Parameters
import moe.brianhsu.porting.live2d.enitiy.avatar.settings.detail.MotionSetting.{Curve, Meta}
import moe.brianhsu.porting.live2d.enitiy.avatar.settings.detail.PoseSetting.Group
